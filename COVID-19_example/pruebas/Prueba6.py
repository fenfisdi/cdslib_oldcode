# Alerta:
# No vulnerables:
# S: 0.7, E: 0.5, A: 0.5, MI: 0.3, MOI: 0.3, SI: 0.3
# Vulnerables:
# S: 0.8, E: 0.6, A: 0.6, MI: 0.5, MOI: 0.5, SI: 0.5

# Radios de evacion bajos
# No vulnerables:
# MI: 2.5, MOI: 2.0, SI: 1.5
# Vulnerables:
# MI: 2.5, MOI: 2.5, SI: 1.5
...
if __name__ == "__main__":
        ...
        'dynamics_of_alertness_of_disease_states_by_vulnerability_group': {  
            'not-vulnerable': {
                'susceptible': {
                    ...
                    'alertness_probability': 0.7
                    },
                'exposed': {
                    'should_be_alert': True,
                    'alertness_probability': 0.5
                    },
                'asymptomatic': {
                    'should_be_alert': True,
                    'alertness_probability': 0.5
    ...
    basic_population.agents_info_df.to_csv('Prueba6.csv', index=False)
