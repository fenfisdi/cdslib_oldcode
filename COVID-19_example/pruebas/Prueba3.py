#Bajas probabilidades de estar alerta
#NO vulnerables 0.2, Vulnerables 0.4
import time
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    basic_population.agents_info_df.to_csv("Prueba3.csv", index=False)
