# Medianamente comportados
# Cambiamos las probabilidades de alerta.
# NO vulnerables: 0.5, Vulnerables: 0.7
...
if __name__ == "__main__":
    ...
    basic_population.agents_info_df.to_csv('Prueba1.csv', index=False)
